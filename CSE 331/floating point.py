...
# -*- coding: utf-8 -*-
"""asset-v1_buX+CSE330+2020_Summer+type@asset+block@Floating_Point_Representation_Summer2020_Student.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S1l0flOV4VEeJmY-UpoyXCQVDk8I9YeJ

# Floating Point Representation

## 8 bit Floating Point Representation

We will implement a 8 bit Floating point number system in this part
...
If exponent is 7 then and mantissa is zero then the number is 
...
class Float8():
    ...
    def __init__(self, bitstring):
        ...
        self.exponent = bitstring[1:4] #1,2,3

        # Assign the mantissa
        # self.mantissa = bitstring[?]
        self.mantissa = bitstring[4:] #4 to end
    ...
    def calculate_value(self):
        ...
        if self.exponent == '111':
            c=0
            # mantissa er moddhe 1 pele inf else null.
            for index, bit in enumerate(self.mantissa, 1):
                if bit == '1':
                    c+=1
                if c == 0:
                    val=math.inf
        ...
        # Handle the case of subnormals
            ...
            val= 0.0 ##because 0.fraction   ##ekhane val hosse mantessa er val = exponent er val

            for i, bit in enumerate(self.mantissa,1):
                if bit =='1':
                    val+= pow(2,-i)
            val *= pow(2,-2)  #1-3= -2
        ...
        # Handle the case of normals
            ...
            val = 1.0 ##because 1.fraction ##ekhane val hosse mantessa er val = exponent er val
...
"""Now we will test to see whether the functions are complete or not."""
